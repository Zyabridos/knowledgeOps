const en = {
  ...
  home: {
    ...
    scenariosDescription:
      "List of scenarios with progress, notes, house rules and setup photos. Perfect to remember what happened in each mission.",
    scenariosCta: "Open scenarios →",
    printingTitle: "3D Printing Storage",
    printingBadge: "STL library",
    printingDescription:
  ...
  frosthavenList: {
    ...
    description:
      "Journal of Frosthaven scenarios with photos, notes and party composition. Click a card to open the detailed page.",
    emptyText:
      "There are no scenarios yet. Create an entry in Sanity Studio with type frosthavenScenario.",
    dateLabel: "Date",
    playersLabel: "Players",
    scenarioLevelLabel: "Scenario level",
    soloLabel: "Solo",
    outcomeLabel: "Outcome",
    openCta: "Open scenario →",
  },
  printing: {
